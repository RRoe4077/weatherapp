...
//var Iphone = React.createClass({
		...
		return (
			<div class={ style.container } style={ {backgroundColor: this.state.background} }>
				<div class={ style.header }>
					...
					<div class={ style.temp}>{ weather.temp_c }°C</div>
					<div class={ style.conditions }>Wind: { weather.windspeed } m/s</div>
					<div class={ style.conditions }>{ weather.condition } </div>
					<div class={ style.icon }><img src={conditionsIconSrc} alt='Icon depicting current weather.'/></div>
	...
	parseResponse = (parsed_json) => {
		...
		console.log(parsed_json.sys.sunrise, parsed_json.sys.sunset );
